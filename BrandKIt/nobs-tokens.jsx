...
const NOBS = {
  // ── Colors ───────────────────────────────────────────────────
  // Light palette: warm off-whites and warm grays
  light: {
    bg: '#FAF8F5',          // app background
    surface: '#FFFFFF',     // cards
    surfaceAlt: '#F2EEE7',  // sunken / subtle fills
    border: 'rgba(60,40,20,0.08)',
    divider: 'rgba(60,40,20,0.06)',
    text: '#1C1917',        // primary text
    textSecondary: '#57534E',
    textTertiary: '#A8A29E',
    placeholder: '#C2BBB3',
    shadow: '0 1px 2px rgba(60,40,20,0.04), 0 4px 16px rgba(60,40,20,0.06)',
    shadowLg: '0 2px 6px rgba(60,40,20,0.05), 0 12px 32px rgba(60,40,20,0.08)',
  },
  // Dark palette: deep warm charcoals (not pure black)
  dark: {
    bg: '#1C1917',
    surface: '#28231F',
    surfaceAlt: '#221E1A',
    border: 'rgba(255,240,220,0.07)',
    divider: 'rgba(255,240,220,0.05)',
    text: '#F5F1EA',
  ...
  brand: {
    ...
    sage:       '#65A36E',
    sageDeep:   '#3F7E47',
    sageTint:   'rgba(101,163,110,0.12)',
    sageTintD:  'rgba(101,163,110,0.18)',
    rose:       '#C75D5D',   // danger
    roseTint:   'rgba(199,93,93,0.10)',
    blue:       '#5680A8',   // info
  },
