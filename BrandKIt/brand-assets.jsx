...
const ASSET_FILES = [
  ...
  ['icon', 'assets/icon/NOBS-icon-amber.svg',  'amber',  '1024 · default', 'paper'],
  ['icon', 'assets/icon/NOBS-icon-sage.svg',   'sage',   '1024 · variant', 'paper'],
  ['icon', 'assets/icon/NOBS-icon-ink.svg',    'ink',    '1024 · variant', 'paper'],
  ['icon', 'assets/icon/NOBS-icon-cream.svg',  'cream',  '1024 · inverse', 'cream'],
  ['icon', 'assets/icon/NOBS-icon-tick.svg',   'tick',   'accent · check', 'paper'],
  ['icon', 'assets/icon/NOBS-icon-dot.svg',    'dot',    'accent · period', 'paper'],
  ['icon', 'assets/icon/NOBS-icon-bare.svg',   'bare',   'accent · none',  'paper'],

  ['wordmark', 'assets/wordmark/NOBS-wordmark-light.svg', 'light', '1200 × 360', 'cream'],
  ['wordmark', 'assets/wordmark/NOBS-wordmark-dark.svg',  'dark',  '1200 × 360', 'ink'],
  ['wordmark', 'assets/wordmark/NOBS-wordmark-amber.svg', 'amber', '1200 × 360', 'paper'],
  ['wordmark', 'assets/wordmark/NOBS-wordmark-mono.svg',  'no tagline', '1200 × 360', 'cream'],

  ['lockup', 'assets/lockup/NOBS-lockup-horizontal.svg',      'horizontal',       '1400 × 420', 'cream'],
  ['lockup', 'assets/lockup/NOBS-lockup-horizontal-dark.svg', 'horizontal · dark','1400 × 420', 'ink'],
  ['lockup', 'assets/lockup/NOBS-lockup-stacked.svg',         'stacked',          '720 × 900',  'cream'],
  ['lockup', 'assets/lockup/NOBS-lockup-stacked-dark.svg',    'stacked · dark',   '720 × 900',  'ink'],

  ['banner', 'assets/banner/NOBS-og-card.svg',         'og card',         '1200 × 630',  'paper'],
  ['banner', 'assets/banner/NOBS-profile-header.svg',  'profile header',  '1500 × 500',  'ink'],
  ['banner', 'assets/banner/NOBS-square-post.svg',     'square post',     '1080 × 1080', 'amber'],
  ['banner', 'assets/banner/NOBS-story.svg',           'story',           '1080 × 1920', 'cream'],
  ['banner', 'assets/banner/NOBS-stickers.svg',        'sticker sheet',   'print',       'paper'],

  ['palette', 'assets/palette/NOBS-palette.svg', 'palette', '9 colors · v1.0', 'cream'],
];
  ...
  return (
    <section style={{ paddingTop: 24 }}>
      <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: 32, marginBottom: 24 }}>
        <Meta>NOBS / assets / v1.0 — may 2026</Meta>
        <Meta style={{ textAlign: 'right' }}>23 files · all SVG · scalable</Meta>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 32, marginTop: 8 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ fontFamily: sans, fontSize: 22, lineHeight: '30px', color: BK.ink2, marginTop: 6, maxWidth: 640 }}>
              Every logo, mark, lockup and banner — ready to drop into product, social or print.
              Open any tile for the source SVG; download the folder at the bottom.
            </div>
          </div>
        </div>
