...
const roadmap = [
  ...
  ["Earn trust through action", "The agent core proposes, you approve. Activity shows pending changes with explicit Approve and Deny actions on iPhone.", "shipped"],
  ["Understand the day", "Morning Briefing v2 from calendar and reminders, with on-device generation and Tank refinement when connected.", "shipped"],
