...
- Contributions are accepted under `CONTRIBUTING.md` rules; opening a pull request confirms you have the right to submit that work under the repository's license.
